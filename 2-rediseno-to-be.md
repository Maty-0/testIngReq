...
|----------------|----------|----------|-----------------|
| Dirección Docente / Universidad | Difundir la oferta académica semestral. | La publicación mediante archivos Excel heterogéneos y desarticulados obliga al procesamiento manual y genera errores de consulta. | La oferta sigue publicándose de manera independiente, pero se proporciona un traductor e ingesta comunitaria para estandarizar sus datos. |
...
|-------------------------|--------------------------|------------|
| Publica Excel de propuesta académica / Revisa la propuesta académica | Cargar y traducir Excel de oferta a formato unificado | La lectura manual del Excel estático es sustituida por un procesador/traductor que extrae asignaturas, secciones y bloques horarios a una estructura web reutilizable. |
...
| Guarda su horario | Confirmar y guardar horario simulado | Se permite almacenar o exportar la combinación óptima validada para el proceso de inscripción formal. |